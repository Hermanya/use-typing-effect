...
const Command: React.StatelessComponent<{
  className?: string;
  children: string;
}> = ({ children, className }) => (
  <input
    className={`form-control text-monospace  border-0 bg-transparent text-center mb-3 ${className ||
      ''}`}
    readOnly
  ...
  return (
    <div>
      <div className="position-relative overflow-hidden p-3 p-md-5 mt-md-3 mx-md-3 text-center bg-light">
        <div className="col-md-8 p-lg-8 mx-auto my-5">
          ...
          <a
            ...
            href="https://www.npmjs.com/package/use-typing-effect"
          >
            npm
          </a>
          <a
            className="btn btn-dark ml-2"
            href="https://github.com/Hermanya/use-typing-effect"
          >
            github
          </a>
        </div>
      ...
      <div className="mx-3 d-flex flex-align-center">
        <textarea
          className="col-sm-8 col-md-6 col-lg-5 p-3 px-lg-5 mx-auto text-left bg-dark text-success rounded shadow text-monospace form-control border-0"
